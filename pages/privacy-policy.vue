<template>
  <section>
    ...
    <p>
      ...
      collected and recorded by Overworked and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      visitors to our application with regards to the information that they
      shared and/or collect in Overworked. This policy is not applicable to any
    ...
    <h2>Log Files</h2>
    <p>
      Overworked follows a standard procedure of using log files. These files
      log visitors when they visit applications. All hosting companies do this
    ...
    <p>
      ...
      advertisements and links that appear on Overworked, which are sent
      ...
      content that you see on applications that you visit.
    </p>
    <p>
      Note that Overworked has no access to or control over these cookies that
    ...
    <p>
      ...
      web browsers, it can be found at the browsers' respective applications.
    </p>
    ...
    <p>
      Overworked does not knowingly collect any Personal Identifiable
      Information from children under the age of 13. If you think that your
      child provided this kind of information on our application, we strongly
