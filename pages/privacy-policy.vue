<template>
  ...
  <p>
    At Overworked, one of our main priorities is the privacy of our visitors.
    This Privacy Policy document contains types of information that is collected
    and recorded by Overworked and how we use it.
  </p>
  <p>
  ...
  <p>
    ...
    visitors to our application with regards to the information that they shared
    and/or collect in Overworked. This policy is not applicable to any
    information collected offline or via channels other than this application.
  ...
  <ul>
    ...
    <li>
      ...
      information relating to the application, and for marketing and promotional
      purposes
    </li>
  ...
  <h2>Log Files</h2>
  <p>
    Overworked follows a standard procedure of using log files. These files log
    visitors when they visit applications. All hosting companies do this and a
    ...
    administering the site, tracking users' movement on the application, and
  ...
  <p>
    ...
    and links that appear on Overworked, which are sent directly to users'
  ...
  <p>
    Note that Overworked has no access to or control over these cookies that are
    used by third-party advertisers.
  </p>
  <h2>Third Party Privacy Policies</h2>
  <p>
    Overworked's Privacy Policy does not apply to other advertisers or
    applications. Thus, we are advising you to consult the respective Privacy
  ...
  <p>
    ...
    browsers, it can be found at the browsers' respective applications.
  </p>
  ...
  <p>
    Overworked does not knowingly collect any Personal Identifiable Information
